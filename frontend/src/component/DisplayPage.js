...
<div className='pb-3'>
  ...
  <h3 className="text-center mt-1 mb-0">Renumeration Bill Form of Examination Work</h3>
    ...
    <div >
    <h6>Name of the Examiner: {username && <span>{username.name}</span>}</h6>
      <h6>Designation: {username && <span>{username.designation}</span>}</h6>
      <h6>Address: {username && <span>{username.address}</span>}</h6>
    </div>
  ...
  <div className="col-md-6 text-center">
    <div className="border p-3">
      ...
      <p><strong>Sign of the Committee Chairman</strong></p>
    </div>
  </div>
  <div className="col-md-6 text-center">
    <div className="border p-3">
